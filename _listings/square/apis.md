...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/category/master/_listings/square/apis.md
...
- name: Square Connect API Creates an item category.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/category/master/_listings/square/v1location-idcategories-post-openapi.md
- name: Square Connect API Deletes an existing item category.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/category/master/_listings/square/v1location-idcategoriescategory-id-delete-openapi.md
- name: Square Connect API Modifies the details of an existing item category.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/category/master/_listings/square/v1location-idcategoriescategory-id-put-openapi.md
- name: Square Connect API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/category/master/_listings/square/openapi.md
x-common:
- type: x-website
  url: http://square.com
- type: x-base
